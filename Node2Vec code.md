...
</br>![](https://github.com/f1rstb100d/GE/blob/master/png/alias_table.png)</br>
两个数组，一个里面存着第i列对应的事件i矩形站的面积百分比【也即其概率】，上图的话数组就为Prab[![](http://latex.codecogs.com/gif.latex?\\frac{2}{3}), ![](http://latex.codecogs.com/gif.latex?1), ![](http://latex.codecogs.com/gif.latex?\\frac{1}{3}), ![](http://latex.codecogs.com/gif.latex?\\frac{1}{3})]，另一个数组里面储存着第i列不是事件i的另外一个事件的标号，像上图就是Alias[2, NULL, 1, 1] 。
